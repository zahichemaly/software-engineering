...
namespace husseinhajj_tp2
{
    ...
    {
        public AdminUser(int id, string firstName, string lastName, DateTime dateOfBirth, bool fiftyFiftyStatus, int pityCounter, int pulls, Status status, int balance) : base(id, firstName, lastName, dateOfBirth, fiftyFiftyStatus, pityCounter, pulls, status, balance)
        {
