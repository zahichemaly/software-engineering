...
namespace eShop.IntegrationTests
{
    public class BasketTest : IntegrationTest
    {
        ...
        {
            // Arrange
            var buyerId = "BuyerId"; // Replace with an appropriate buyer ID for your test
            var catalogItemId = 1; // Replace with an appropriate catalog item ID for your test
            var unitPrice = 9.99m; // Replace with an appropriate unit price for your test
            var quantity = 2; // Replace with an appropriate quantity for your test
