...
namespace CarGallery.Repositories
{
    public class CarRepository : ICarRepository
    {
        ...
        public Car Get(string id)
        {
            ...
            {
                var filter = Builders<Car>.Filter.Eq(c => c.Id, carIn.Id); cars.DeleteOne(filter);
...

            {
                ...
                var filter = Builders<Car>.Filter.Eq(c => c.Id, id); cars.DeleteOne(filter);
            ...
            public void Update(string id, Car carIn)
            {
                ...
                {
                    IsUpsert = false // Set to true if you want to insert the document if it doesn't exist
                };
