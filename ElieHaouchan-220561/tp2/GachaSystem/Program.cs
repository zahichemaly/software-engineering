...
namespace GachaSystem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            EB.StartDate = DateTime.Now;
            EB.EndDate = DateTime.Now.AddMinutes(1);
            EB.Cost = 1;
            ...
            for (int i = 1; i <= 10; i++)
            {
                GachaItem item = PerformPull(player, EB, PB);
        ...
        {
            string filePath = "C:/Users/User/software-engineering/ElieHaouchan-220561/tp2/gacha.txt";
